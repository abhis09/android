...
import com.example.new_meditation.Adapter.SoftsongAdapter;
import com.example.new_meditation.Adapter.ViewPagerAdapter;
import com.example.new_meditation.Database.DatabaseHandler;
import com.example.new_meditation.Database.FavoritesOperations;
import com.example.new_meditation.Model.Downloads;
import com.example.new_meditation.Model.SongsList;
...
public class PlayListActivity extends AppCompatActivity implements View.OnClickListener, AllSongFragment.createDataParse, FavSongFragment.createDataParsed, CurrentSongFragment.createDataParsed {
    private Menu menu;
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                if (playContinueFlag) {
                    if (currentPosition + 1 < songList.size()) {
                        ...
                        Toast.makeText(PlayListActivity.this, "PlayList Ended", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
