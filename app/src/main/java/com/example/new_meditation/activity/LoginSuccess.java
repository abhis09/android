...
import com.example.new_meditation.Database.DatabaseHelper;
...
public class LoginSuccess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty() || password.isEmpty()) {
                    Toast.makeText(LoginSuccess.this, "Enter your Email and Password to login", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (cursor != null) {
                        if (cursor.getCount() > 0) {
                            startActivity(new Intent(LoginSuccess.this, PreMain.class));
        ...
        tvRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginSuccess.this,Registration.class));
                finish();
            }
        });
